...
**Course Code:** C481  |  **Conducted by:** Tertiary Infotech Academy Pte Ltd (UEN 201200696W)  |  **Version v2.0 · 23 September 2026**
...
- lab02-baseline-defect-summary.xlsx — The monthly baseline used to calculate the defect rate, DPMO and sigma level. These figures are quoted consistently across every lab.
...
7. Run 'Check my SIPOC' in the tool to validate your diagram against the lab criteria, then export it as PNG or PDF for your project pack.
