...
- **[`lab02-baseline-defect-summary.xlsx`](data/lab02-baseline-defect-summary.xlsx)** — The monthly baseline used to calculate the defect rate, DPMO and sigma level. These figures are quoted consistently across every lab.
