...
lunch, tea within). NON-WSQ: no assessment, attendance or funding content —
the time a WSQ run spends on the final papers is reallocated to hands-on
consolidation and recap. Topics/labs come from
...
SCHEDULE = {
 1: (C.DAY_THEMES[1], [
    ("9:30","10:00",30,"admin","Welcome, course introduction and ground rules"+sl("Admin")),
 ...
 2: (C.DAY_THEMES[2], [
    ("9:30","9:45",15,"recap","Day 1 recap and warm-up discussion"),
 ...
 3: (C.DAY_THEMES[3], [
    ("9:30","9:45",15,"recap","Day 2 recap and warm-up discussion"),
    ...
    ("18:15","18:30",15,"recap","Day 3 recap and Q&A"),
 ]),
 4: (C.DAY_THEMES[4], [
    ("9:30","9:45",15,"recap","Day 3 recap and warm-up discussion"),
    ...
    ("15:30","16:45",75,"lab","Hands-on: "+lab_titles([24,25])+sll([24,25])),
    ("16:45","17:45",60,"lab","Consolidating your improvement package — assemble the outputs of Labs 1-25 into the A3 storyboard and finalise the handover pack"),
    ("17:45","18:30",45,"recap","Course recap against the learning outcomes, Q&A and wrap-up"+sl("Wrap-up")),
 ]),
}
...
prodoc.add_version_control(doc,[
 ("1.0",C.VERSION_DATE,"Initial non-WSQ release (C481) - same 4-day DMAIC progression, 25 hands-on "
  "labs and CSSC Green Belt (Ch 1-24) depth as the accredited counterpart course, with all "
  "compliance and graded-paper content removed; the freed Day 4 time is reallocated to hands-on "
  "consolidation and recap.",C.TRAINER),
])
prodoc.add_toc(doc)
...
for a in ["Learning is reinforced continuously in class rather than through a graded paper:",
          "Every concept is followed immediately by a hands-on lab that applies it to the running Northwind scenario.",
          "Each lab ends with a 'Check your work' step so learners verify their own output before moving on.",
          "Lab outputs accumulate into one complete improvement package — charter, VOC/CTQ, maps, MSA, baseline, root causes, countermeasures and control plan.",
          "Day 4 closes with a consolidation session and a recap against the learning outcomes."]:
