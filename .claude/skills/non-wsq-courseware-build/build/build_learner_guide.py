...
formulas and a glossary. NON-WSQ: no assessment, attendance or funding content. All content is driven by
...
p(f"This Learner Guide accompanies the course {C.TITLE} ({C.COURSE_CODE}), conducted by {C.ORG}. "
  ...
  "step-by-step instructions for every hands-on lab. Core labs are completed by everyone; elective labs "
  "are provided as additional practice and are run when time allows.")
...
h1("Consolidating What You Learned")
bullets([
...
prodoc.add_version_control(doc,[
 ("1.0",C.VERSION_DATE,"Initial non-WSQ release (C481) - same 4-day DMAIC progression, 25 hands-on "
  "labs, CSSC Green Belt (Ch 1-24) depth and Northwind Retail Distribution Centre running scenario "
  "as the accredited counterpart course, with all compliance and graded-paper content removed.",C.TRAINER),
])
prodoc.add_toc(doc)
