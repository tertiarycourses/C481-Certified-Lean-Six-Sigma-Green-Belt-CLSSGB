...
def define_phase(d):
    ...
    d.tile_grid(
        "The two categories most teams forget", [
            ("INDIFFERENT", "Performance changes but satisfaction does not move. Pure waste - stop investing in it."),
    ...
    d.tile_grid(
        "Build it in the browser - SIPOC & Process Map Builder", [
            ...
            ("Check my SIPOC", "Validates your diagram against the lab criteria before you export it."),
