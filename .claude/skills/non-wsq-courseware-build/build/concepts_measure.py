...
def measure_phase(d):
    ...
    d.formula_card("Takt time - worked example", [
        ...
        note="Use only productive time - exclude breaks, meetings and planned downtime from the available time.")
    ...
    d.flow_h("Attribute Gage R&R - the procedure", [
        ...
        "Repeat the appraisals in a RANDOMISED order so trial 1 cannot be recalled",
