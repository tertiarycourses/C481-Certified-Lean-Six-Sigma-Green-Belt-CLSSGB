...
# labs, deck and LG can never drift onto different scenarios.
...
def readme_md():
    ...
    out.append("")
    out.append(f"**Course Code:** {C.COURSE_CODE}  |  **Version {C.VERSION} · {C.VERSION_DATE}**")
    out.append("")
    ...
    out.append("")
    out.append("- **Core** — completed by everyone; builds the improvement package step by step.")
...
def repo_readme(files):
    ...
    out.append("")
    out.append(f"> **Course:** {C.TITLE}  ")
    out.append(f"> **Course Code:** {C.COURSE_CODE}  ")
    out.append("> **Register here:** https://www.tertiarycourses.com.sg/certified-lean-six-sigma-green-belt.html")
    out.append("")
    out.append(f"These are the hands-on lab exercises for the {C.TITLE} course delivered by "
    ...
    out.append("- [Course registration page](https://www.tertiarycourses.com.sg/certified-lean-six-sigma-green-belt.html)")
