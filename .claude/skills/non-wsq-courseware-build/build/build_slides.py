#!/usr/bin/env python3
"""Build the C481 CLSSGB slide deck — all-white Tertiary house style, DMAIC order.
...
Structure:
  Cover -> Admin (trainers x2, ground rules, LMS, lesson plan x4 days,
...
d.trainer_slide("YOUR TRAINER", C.TRAINER,
                ...
                [("Role", "Principal Trainer, Tertiary Infotech Academy Pte. Ltd."),
                 ...
                 ("Delivers", "Courses on Lean Six Sigma, quality management and data analytics."),
...
if lms:
    ...
    d.flow_h("Download Your Course Material", [
        ...
        "Keep them open alongside the labs as you work",
...
d.two_col("Lesson Plan — Days 3 & 4",
          ...
          [("Day 4 — " + C.DAY_THEMES[4], 0),
           ...
           ("Consolidation · Recap against the learning outcomes", 1)],
          kicker="SCHEDULE · 9:30am-6:30pm with a 1-hour lunch",
...
d.flow_h("How You'll Learn", [
    ...
    "Verify with the lab's 'Check your work' step",
    "Discuss and troubleshoot together",
    "Recap against the learning outcomes",
], kicker="LEARNING APPROACH", color=VIOLET)
...
# ============================================================ CLOSE (non-WSQ house order)
d.content("Keep Practising After the Course", [
    "Re-run the labs on your own data — repetition is what makes the skills stick.",
    "Apply DMAIC to a real process in your own organisation.",
